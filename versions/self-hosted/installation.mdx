...
You can check the [Varialbes](/versions/self-hosted/variables) sectipon to get the list of all necessary varialbes 
...
To get more information about how you can test locally build SDK, refer to the [Testing](/versions/self-hosted/testing) section